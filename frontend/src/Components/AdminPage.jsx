...
//             try {
//                 const response = await axios.get('http://localhost:5001/api/accepted-bookings');
//                 setUsers((prevUsers) =>
//                     prevUsers.map((user) => ({
//                         ...user,
//                         bookings: user.bookings.map((booking) =>
//                             response.data.bookings.find((b) => b._id === booking._id) || booking
//                         ),
//                     }))
//                 );
//             } catch (error) {
...
export default function AdminPage() {
    ...
    const handleAccept = async (bookingId) => {
        try {
            await axios.put(`http://localhost:5001/api/accept-booking/${bookingId}`);
            alert('Booking accepted');
    ...
    const handleReject = async (bookingId) => {
        try {
            await axios.put(`http://localhost:5001/api/reject-booking/${bookingId}`);
            alert('Booking rejected');
